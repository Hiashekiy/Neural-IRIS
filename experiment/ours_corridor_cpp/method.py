...
def _candidate_paths():
    base = os.path.join(_ROOT, "cpp_accel")
...
def _lazy_init():
    ...
    onnx_path = os.path.join(_ROOT, "cpp_accel", "models", "corridor_ellipse_net.onnx")
    if not os.path.isfile(onnx_path):
        raise NotImplementedError("ours_corridor_cpp unavailable: ONNX model missing in cpp_accel/models")
